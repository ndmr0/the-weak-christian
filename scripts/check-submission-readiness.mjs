...
assert(readme.includes("layout-safe"), "README must explain the layout-safe encouragement pool");
assert(reviewNotes.includes("layout-safe subset"), "Review notes must explain the layout-safe encouragement pool");
